...
----------------------------------------------------------------------------
-- Credits to Azil for the base code of this from his awesome skinning Addon
-- If you want more skins for AddOns get Azils' AddOn from here
-- http://www.tukui.org/addons/index.php?act=view&id=50
----------------------------------------------------------------------------
...
for _, object in pairs(CliqueButtons) do
	_G[object]:StripTextures()
	_G[object]:SkinButton()
end

P.SkinCloseButton(CliqueConfigCloseButton)
if CliqueDialog.CloseButton then P.SkinCloseButton(CliqueDialog.CloseButton) end
if CliqueDialogCloseButton then P.SkinCloseButton(CliqueDialogCloseButton) end
