...
local function SkinObjects(frame, nameFrame)
	...
	hp.level:SetFont(C.media.pixelfont, 7, "MONOCHROMEOUTLINE")
	...
	if C["nameplate"].showhealth == true then
		...
		hp.value:SetFont(C.media.pixelfont, 7, "MONOCHROMEOUTLINE")
	...
	hp.name:SetFont(C.media.pixelfont, 7, "MONOCHROMEOUTLINE")
	...
	cb.time:SetFont(C.media.pixelfont, 7, "MONOCHROMEOUTLINE")
	...
	if C.nameplate.showcastbarname == true then
		...
		cb.name:SetFont(C.media.pixelfont, 7, "MONOCHROMEOUTLINE")
	...
	if C.nameplate.debuffs == true then
		if not frame.icons then
			...
			frame.icons:SetPoint("BOTTOMRIGHT", frame.hp, "TOPRIGHT", 0, 7)
...
local function ShowHealth(frame, ...)
	...
	if UnitName("target") and frame:GetParent():GetAlpha() == 1 then
		if C["nameplate"].showhealth == true then
			frame.hp:SetSize((C.nameplate.width + C.nameplate.adwidth) * noscalemult, ((C.nameplate.height) * noscalemult)+ 8)
			frame.cb:SetSize((C.nameplate.width + C.nameplate.adwidth) * noscalemult, (C.nameplate.height) * noscalemult)
			frame.cb.icon:SetSize(((C.nameplate.height + C.nameplate.adheight) * 2) + 8, ((C.nameplate.height + C.nameplate.adheight) * 2) + 8)
		else
			frame.hp:SetSize((C.nameplate.width + C.nameplate.adwidth) * noscalemult, (C.nameplate.height) * noscalemult)
			frame.cb:SetSize((C.nameplate.width + C.nameplate.adwidth) * noscalemult, (C.nameplate.height) * noscalemult)
			frame.cb.icon:SetSize(((C.nameplate.height + C.nameplate.adheight) * 2) + 8, ((C.nameplate.height) * 2) + 8)
		end
	else
		if C["nameplate"].showhealth == true then
